...
# Query for tile books.com.tw-Taiwan Extractor
client.query({"input"=>{"webpage/url"=>"http://www.books.com.tw/products/0010584286"},"connectorGuids"=>["eff005d0-c8c3-4c47-a47b-978dc65a0323"]}, callback )

# Query for tile books.com.tw-Taiwan Extractor
client.query({"input"=>{"webpage/url"=>"http://www.books.com.tw/products/0010419705"},"connectorGuids"=>["eff005d0-c8c3-4c47-a47b-978dc65a0323"]}, callback )

# Query for tile books.com.tw-Taiwan Extractor
client.query({"input"=>{"webpage/url"=>"http://www.books.com.tw/products/0010496771"},"connectorGuids"=>["eff005d0-c8c3-4c47-a47b-978dc65a0323"]}, callback )

# Query for tile books.com.tw-Taiwan Extractor
client.query({"input"=>{"webpage/url"=>"http://www.books.com.tw/products/0010539585"},"connectorGuids"=>["eff005d0-c8c3-4c47-a47b-978dc65a0323"]}, callback )
