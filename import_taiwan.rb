...
CSV.foreach('data/books.com.tw.csv', options) do |row|
  client.query({"input"=>{"webpage/url"=>row},"connectorGuids"=>["eff005d0-c8c3-4c47-a47b-978dc65a0323"]}, callback )
end
...
results_file = File.new('data/taiwan_results.json', 'a') unless File.exists?('data/taiwan_results.csv')
