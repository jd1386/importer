...
client.query({"input"=>{"isbn"=>"9788879832724"},"connectorGuids"=>["b7b06882-4e42-49c4-b3c2-098d6bf938c8"]}, callback )

# Query for tile it_search_and_extract_feltrinelli
client.query({"input"=>{"isbn"=>"9788879833073"},"connectorGuids"=>["b7b06882-4e42-49c4-b3c2-098d6bf938c8"]}, callback )

# Query for tile it_search_and_extract_feltrinelli
client.query({"input"=>{"isbn"=>"9788882896140"},"connectorGuids"=>["b7b06882-4e42-49c4-b3c2-098d6bf938c8"]}, callback )

# Query for tile it_search_and_extract_feltrinelli
client.query({"input"=>{"isbn"=>"9788854118577"},"connectorGuids"=>["b7b06882-4e42-49c4-b3c2-098d6bf938c8"]}, callback )

# Query for tile it_search_and_extract_feltrinelli
client.query({"input"=>{"isbn"=>"9788854172098"},"connectorGuids"=>["b7b06882-4e42-49c4-b3c2-098d6bf938c8"]}, callback )
